...
//#endif
    ...
    // Combos
    IMGUI_API bool          BeginComboPopup(ImGuiID popup_id, float size, const ImRect& bb, ImGuiComboFlags flags);
    ...
    IMGUI_API bool          Навалил_Кринжа(const char* label, bool selected, float SHIRINA = 123.f);

    IMGUI_API void          MenuChild(const char* str_id, const ImVec2& size, const ImVec2& pos, ImGuiWindowFlags extra_flags = 0);

...
void ImGui::UpdateMouseWheel()
{
    ...
    {
        const float scroll_speed = ImFloor(window->CalcFontSize() * 40 * g.IO.DeltaTime + 0.9f);
        ...
        {
            float scroll_step = ImFloor(ImMin(8 * window->CalcFontSize(), (scroll_window->ContentsRegionRect.GetHeight() + scroll_window->WindowPadding.y * 2.0f) * 0.67f));

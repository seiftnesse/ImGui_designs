...
namespace ImGui
{
    ...
    IMGUI_API bool          ButtonActive(const char* label, const bool active, const ImVec2& size = ImVec2(0, 0));   // button
    ...
    IMGUI_API bool          Tab(const char* label, const bool active = false, const ImVec2& size_arg = ImVec2(0, 0));
